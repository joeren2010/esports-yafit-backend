...
@WebServlet("/trainers-crud")
public class TrainersCrudController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (id != null) {
			Trainers trainer = trainerDao.getOne(Long.parseLong(id));
		...
		String jsonResponse = new Gson().toJson(trainerList);	//convert java object to json string
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			trainer.setTrnrId(Integer.parseInt(request.getParameter("trnrId")));
			...
			dto.setMessage("Trainer updated successfully!");
		} 
		catch (Exception e) {
			dto.setMessage("Unable to update Trainer!");
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			trainerDao.delete(Integer.parseInt(id));
			dto.setMessage("Trainer deleted successfully!");
		} 
		catch (Exception e) {
			dto.setMessage("Unable to delete Trainer!");
			dto.setError(e.toString());
		}
